...
let splitMe = function (stringa) {
  ...
  paroleStringa = paroleStringa.map((parola) => parola.charAt(0).toUpperCase() + parola.slice(1));
  return paroleStringa;
};
...
*/
let deleteOne = function (stringa, condizione) {
  if (condizione) {
    let nuovaStringa = stringa.slice(-3);
    return nuovaStringa;
  } else {
    let nuovaStringa = stringa.slice(0, 3);
    return nuovaStringa;
  }
};
...
/* ESERCIZIO 6
  Crea una funzione chiamata "isThisAnEmail" che riceve una stringa 
  come parametro e ritorna true se la stringa è un valido indirizzo email.
*/
let isThisAnEmail = function (stringa) {
  if (stringa.match(chiocciola) && (stringa.match(network1) || stringa.match(network2))) {
    return true;
  } else {
    return false;
  }
...
let network1 = ".net";
let network2 = ".com";
console.log(isThisAnEmail("laventura@gmail.com"));
/* ESERCIZIO 7
...
let rollTheDices = function (num) {
  ...
  let somma = 0;
  for (let k = 0; k < numeriEstratti.length; k++) {
    let valoriSingoli = numeriEstratti[k];
    somma += valoriSingoli;
  }
  return somma;
};

console.log("somma dei dadi:", rollTheDices(3));
/* ESERCIZIO 9
...
*/
let howManyDays = function (data) {
  let dataPresente = new Date();
  calcolo = dataPresente - data;
  let giorni = Math.floor(calcolo / (1000 * 60 * 60 * 24));
  return giorni;
};
...
let isTodayMyBirthday = function () {
  let dataDiOggi = new Date();
  let giornoPresente = dataDiOggi.getDate();
  let mesePresente = dataDiOggi.getMonth() + 1;
  let dataPresente = `${giornoPresente} ${mesePresente}`;
  console.log(dataPresente);
  let compleanno = new Date("January 15, 2003 23:15:30");
  let giorno = compleanno.getDate();
  let mese = compleanno.getMonth() + 1;
...
*/
let deleteProp = function (oggetto, stringa) {
...
let stringa = "ducati";
console.log(deleteProp(auto, stringa));
/* ESERCIZIO 12
...
console.log(soloAnni2);
/* ESERCIZIO 16
  Scrivi una funzione chiamata "sumAllTheYears" che ritorna la somma di 
  tutti gli anni in cui sono stati prodotti i film contenuti nell'array "movies" fornito.
*/
let sommaAnni = 0;
...
console.log("Totale somma di tutti gli anni dei film:", sumAllTheYears(movies));
/* ESERCIZIO 17
...
*/
let selezioneElemento = function () {
...
*/
let selezioneElemento1 = function () {
  let td = document.querySelectorAll("td");
};
/* ESERCIZIO 22
  Scrivi una funzione che, tramite un ciclo, stampa in console il testo contenuto in ogni tag <td> all'interno della pagina.
*/
let stampaTesto = function () {
  let container = document.getElementById("container");
  let td = document.querySelectorAll("td");
...
*/
let modificaLista = function () {
  let lista = document.getElementById("mylist");
  let elemento = document.createElement("li");
  elemento.innerText = "nuovo elemento lista";
...
let classe = function () {
  ...
  tr.forEach(function (singolitr) {
    singolitr.className = "test";
    container.appendChild(singolitr);
  });
};
classe();
// [EXTRA] JS Avanzato
